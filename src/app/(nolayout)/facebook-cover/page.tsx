...
export default function FacebookCoverPage() {
  const [mode, setMode] = useState<"cover" | "post">("cover");
  ...
  return (
    <main className="min-h-screen bg-[#090704] p-8 flex flex-col items-center justify-center gap-4 overflow-auto">
      <div className="inline-flex items-center rounded-full border border-amber-400/60 bg-black/40 p-1 text-amber-200 shadow-[0_0_18px_rgba(251,191,36,0.15)]">
        <button
          type="button"
      ...
      {mode === "cover" ? (
        ...
        <>
          <label className="w-[900px] max-w-[90vw] rounded-2xl border border-amber-400/50 bg-black/40 p-3 text-amber-200 shadow-[0_0_18px_rgba(251,191,36,0.15)]">
          ...
          <div className="relative w-[1080px] h-[1080px] overflow-hidden border border-amber-500/40 bg-[#0a0704] text-amber-100 shadow-[0_0_120px_rgba(251,191,36,0.2)]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_20%,rgba(255,184,77,0.3),transparent_52%),radial-gradient(circle_at_15%_75%,rgba(255,125,24,0.16),transparent_45%),radial-gradient(circle_at_80%_18%,rgba(255,145,42,0.2),transparent_48%)]" />
            <div className="absolute inset-0 bg-[linear-gradient(130deg,rgba(255,188,95,0.1)_0%,transparent_30%,rgba(255,142,34,0.18)_70%,transparent_100%)]" />

            <div className="absolute -left-10 top-24 h-[420px] w-[420px] rounded-full border border-amber-600/20" />
            <div className="absolute -left-28 top-40 h-[380px] w-[380px] rounded-full border border-amber-700/20" />
            <div className="absolute right-[-150px] bottom-[-140px] h-[420px] w-[620px] rounded-[50%] border border-amber-500/20" />

            <div className="absolute -left-20 top-[286px] text-[360px] font-bold leading-none text-amber-500/10 select-none">
              🐙
            </div>
            ...
            <div className="relative z-10 flex h-full flex-col items-center justify-center px-24 text-center">
              <p className="max-w-[860px] text-[66px] font-bold leading-tight text-amber-100 drop-shadow-[0_0_20px_rgba(251,191,36,0.35)]">
                {postText}
              </p>
            </div>

            <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 bg-gradient-to-t from-[#0a0704]/95 via-[#0a0704]/75 to-transparent px-20 pb-12 pt-24 text-center">
              <p className="text-[54px] font-black tracking-wide text-amber-200/70">
                POLIPMARKET
              </p>
              <p className="mt-1 text-[26px] font-semibold text-amber-200/55">
                Fogadás • Piac • Stratégia
              </p>
            </div>
          </div>

...
Jelen tájékoztató bemutatja, hogy a Polipmarket szolgáltatás használata során az adatkezelő milyen személyes adatokat, milyen célból, milyen jogalapon, meddig kezel, kik férhetnek hozzá az adatokhoz, valamint az érintetteket milyen jogok illetik meg.

## 3. A szolgáltatás rövid leírása

A Polipmarket közösségi előrejelző és közvéleménykutató platform, ahol a felhasználók valós események kimenetelére adhatnak le tippet ("IGEN" / "NEM"). A bejelentkezés Google-fiókkal vagy vendég módban történik. Vendég belépés kezdeményezhető a belépési felületről, illetve bejelentkezés nélkül indított fogadás vagy eseménylétrehozás során is.
...
### 4.1. Fiókazonosításhoz kezelt adatok
...
Vendég belépés esetén:

- rendszer által képzett technikai e-mail azonosító,
- rendszer által képzett megjelenített név,
- visszaállító kulcs titkosított (hash-elt) lenyomata,
- visszaállító kulcs megjelenítésének visszaigazolási időpontja.
...
- **Kezelt adatok:** Google-belépésnél e-mail cím, felhasználónév, profilkép; vendég belépésnél technikai e-mail azonosító, megjelenített név, visszaállító kulcs hash.
...
### 5.2. Szolgáltatás működtetése (szavazások/fogadások/tranzakciók)

- **Cél:** a platform funkcióinak biztosítása, eseményekben való részvétel és kapcsolódó műveletek kezelése.
- **Kezelt adatok:** felhasználói azonosító, e-mail cím, szavazási aktivitás.
- **Jogalap:** GDPR 6. cikk (1) b) pont (szerződés teljesítése).
...
- **Adatkezelés helye:** Frankfurt (EU)
